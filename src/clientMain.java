...
public class clientMain {
    ...
    public static void main(String[] args) throws Exception{
        Map<String,String> orders=new HashMap<>();//场馆使用
            ...
            if(st.equals(" ")){
                ...
                System.out.println("总计:"+total);
                    ...
                    if(m.matches()){
                        ...
                        String period=orders.get(input[3]+startTime+endTime);
                        if(!wholePoint(periodArr[0]) || !wholePoint(periodArr[1])){
                            ...
                            orders.put(input[3]+startTime+endTime,startTime+"--"+endTime);
                        ...
                        if(!wholePoint(periodArr[0]) || !wholePoint(periodArr[1])){
                            ...
                            if (booked==null){
                                ...
                                orders.remove(input[3]+startTime+endTime);
                                Site site=new Site();
    ...
    public static boolean RepeatedVerification(String startTime,String endTime,String period){
        SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm");
        try {
